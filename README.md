...
｛calculatorの場合｝
まず最初に```app5.js``` を起動する．次にWebブラウザでlocalhost:8080/public/calculator.htmlにアクセスする．
使用手順としては，数字1と数字2に好きな数字を入力し，計算するボタンがあるのでプッシュする．
...
{ageの場合}
まず最初に```app5.js``` を起動する．次に，Webブラウザでlocalhost:8080/public/age.htmlにアクセスする
使用手順としては，自分の年齢を入力し，送信ボタンを押す．
